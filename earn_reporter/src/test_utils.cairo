// NOTE: Some test utilities (find_event_index_by_selector, DummyEthAddressContract, etc.) are
// duplicated across packages. This is intentional to keep package dependencies simple and avoid
// circular dependencies. Consider consolidating into a shared test utils package if the
// duplication becomes burdensome.
